...
class LoginVC: UIViewController {
    ...
    @IBAction func forgotPassword(_ sender: UIButton) {
        ...
        let destVC = sb.instantiateViewController(withIdentifier: "ForgotPasswordVC") as! ForgotPasswordVC
        //destVC.emailValue = email.text ?? ""
...
//        }
    ...
    @IBAction func signUp(_ sender: UIButton) {
        SharedMethods.shared.pushToWithoutData(destVC: SignUpVC.self)
    }
